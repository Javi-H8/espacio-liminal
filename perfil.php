...
<body>
  ...
  <main class="container profile-hub">
    <!-- Avatar + nombre -->
    <div class="ph-head">
      <div class="ph-avatar">
    ...
    <section class="ph-group">
      <a class="ph-item" href="#">
        <span class="ph-ico ph-ico--orange" aria-hidden="true"><?= /* puntos */ '' ?>
      ...
      <a class="ph-item" href="#">
        <span class="ph-ico ph-ico--green" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M4 7h16v10H4z"/><path d="M9 11h6v2H9z"/></svg>
        </span>
      ...
      <a class="ph-item" href="#">
        <span class="ph-ico ph-ico--yellow" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M3 6h18v12H3z"/><path d="M7 10h10v4H7z"/></svg>
        </span>
    ...
    <section class="ph-group">
      <a class="ph-item" href="/espacio-liminal/perfil_editar.php">
        <span class="ph-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25Z"/><path d="M20.71 7.04a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83Z"/></svg>
        </span>
        <span class="ph-text">Editar perfil</span>
        <span class="ph-chevron">›</span>
      </a>

      <button class="ph-item" type="button" data-open="#sheetIdioma">
        <span class="ph-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M4 4h16v6H4zM4 14h7v6H4zM13 14h7v6h-7z"/></svg>
        </span>
        <span class="ph-text">Cambiar idioma</span>
        <span class="ph-chevron">›</span>
      </button>

      <button class="ph-item" type="button" data-open="#sheetCategoria">
    ...
    <section class="ph-group">
      <a class="ph-item" href="/espacio-liminal/politicas.php">
        <span class="ph-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M6 2h9l3 3v17H6z"/><path d="M9 8h6M9 12h6M9 16h6"/></svg>
        </span>
  ...
  <?php
    // sheets ya creadas anteriormente
